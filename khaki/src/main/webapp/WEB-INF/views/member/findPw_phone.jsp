...
$(document).ready(
		function() {
			...
			$('#forPhoneBtn').click(function() {
				...
				var d = $('#findPw_phone').serialize()
				$.ajax({
					url: "phoneIdNameCheck.do",
					data: d,
					type: "POST",
...
<body>
	<form action="findPw_phone_go.do" name="findPw_phone" id="findPw_phone">
		<div align="center">
		<br>
			<h4>회원가입 시 등록하신 정보를 입력해주세요.</h4><h4>해당 번호로 임시 비밀번호를 발급해드립니다.</h4>
			...
			<button type="button" class="btn btn-success"
				id="forPhoneBtn" style="height: 40px; margin-top: 12px;">문자발송</button>
		</div>
	</form>
</body>
</html>